// --- Hovedfunktion ---
// Kaldes fra Blazor (C# via IJSRuntime)
// Modtager et "connections"-objekt med nodes[] og links[]
// Tegner hele netværket i <svg id="networkSvg">
window.renderNetwork = (connections) => {

    // Hent SVG-elementet fra DOM
    const svg = document.getElementById("networkSvg");
    svg.innerHTML = ""; // Ryd alt tidligere indhold, så vi starter rent
...
// --- Tegn alle noder (cirkler + labels) ---
function drawNodes(svg, nodes) {
    nodes.forEach(n => {
        // Cirklen repræsenterer personen (noden)
        const circle = createSvgElement("circle", {
            cx: n.x,
            cy: n.y,
            r: 25,
            fill: "#1976d2",     // blå farve
            stroke: "black",
            "stroke-width": 2
        });
        svg.appendChild(circle);

        // Teksten på noden (personens navn)
